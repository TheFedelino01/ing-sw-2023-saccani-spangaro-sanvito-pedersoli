...
public class CommonCardFactory {
    public CommonCard getCommonCard(CardCommonType type) {
        return switch (type) {
            ...
            //case CommonVertical0 -> new CommonVerticalCard(CardCommonType.CommonVertical0, 3, 3);
            ...
            //case CommonVertical1 -> new CommonVerticalCard(CardCommonType.CommonVertical1, 6, 2);
